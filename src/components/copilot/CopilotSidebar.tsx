  ...
  if (lowerQuery.includes("optimize") && (lowerQuery.includes("housekeeping") || lowerQuery.includes("cleaning") || lowerQuery.includes("queue"))) {
    return {
      ...
      tasks: [
        ...
        { id: "t3", title: "Analyze Priorities", description: "Calculating urgency scores based on arrival windows", status: "pending", stepType: "think", autoApprove: true, navigateTo: "/schedule" },
        ...
        { id: "t6", title: "Notify Staff", description: "Pushing updated assignments to staff devices", status: "pending", stepType: "notify", autoApprove: true, navigateTo: "/schedule" },
      ],
  ...
  if ((lowerQuery.includes("prepare") || lowerQuery.includes("setup")) && (lowerQuery.includes("vip") || lowerQuery.includes("arrival") || lowerQuery.includes("guest"))) {
    ...
    return {
      ...
      tasks: [
        ...
        { id: "t2", title: "Analyze Preferences", description: "Cross-referencing past stays with current room setup", status: "pending", stepType: "think", autoApprove: true, navigateTo: "/guests" },
        ...
        { id: "t4", title: "Prepare Amenities", description: "Triggering personalized amenity setup workflow", status: "pending", stepType: "action", autoApprove: true, navigateTo: "/housekeeping" },
        ...
        { id: "t6", title: "Alert F&B Team", description: "Notifying of dietary restrictions and dining preferences", status: "pending", stepType: "notify", target: "F&B", autoApprove: true, navigateTo: "/" },
      ],
      status: "pending_approval",
  ...
  if (lowerQuery.includes("assign") && lowerQuery.includes("room")) {
    ...
    return {
      ...
      tasks: [
        ...
        { id: "t3", title: "Score Room Options", description: "Ranking available rooms by preference match percentage", status: "pending", stepType: "think", autoApprove: true, navigateTo: "/" },
  ...
  if (lowerQuery.includes("send") && (lowerQuery.includes("email") || lowerQuery.includes("message") || lowerQuery.includes("notify"))) {
    return {
      ...
      tasks: [
        ...
        { id: "t2", title: "Analyze Context", description: "Determining optimal message content and timing", status: "pending", stepType: "think", autoApprove: true, navigateTo: "/" },
        { id: "t3", title: "Generate Message", description: "Creating personalized content from template", status: "pending", stepType: "action", autoApprove: true, navigateTo: "/" },
        { id: "t4", title: "Send Communication", description: "Delivering via guest's preferred channel", status: "pending", stepType: "notify", autoApprove: true, navigateTo: "/" },
